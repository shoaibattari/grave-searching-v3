  ...
  return (
    <Link href={`/grave/${Id}`}>
      <motion.div
        ...
        viewport={{ once: true }}
        className="group relative bg-white rounded-[2.5rem] p-5 md:p-7 shadow-sm border border-slate-100 hover:shadow-2xl hover:shadow-emerald-900/10 transition-all overflow-hidden"
      >
        {/* Top Decorative Line */}
        <div className="absolute top-0 left-0 w-full h-1.5 bg-linear-to-r from-emerald-500 to-emerald-200" />
        ...
        <div className=" space-y-2 md:space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2 md:gap-4">
            <div className="flex items-center gap-1.5 md:gap-3">
              <div className="p-2 rounded-lg text-white bg-emerald-600 transition-colors">
        ...
        {/* Hover Action Hint */}
        <div className="mt-2 md:mt-8 flex items-center justify-end">
